...
def extract_questions(content: str, output_dir: Path) -> Dict:
    """
...
def extract_answer_keys(content: str, output_dir: Path) -> Dict:
    """
...
def extract_explanations(content: str, output_dir: Path) -> Dict:
    """
